...
const index = () => {
    ...
    return (
        <ScrollView className='bg-white px-8 flex gap-y-4'>
            <View className='flex gap-y-2'>
                ...
                <TextInput
                    placeholder=''
                    value='Developer'
                    className='px-4 text-lg py-2 bg-teal rounded-xl'
                />
            </View>
            <View className='flex gap-y-2'>
                <Text className='font-nunito-400 text-primary text-lg'>
            ...
            <TouchableOpacity className='bg-primary px-3 py-3 rounded-xl mt-5' onPress={() => {
                ...
                <Text className='text-white text-lg font-nunito-400 self-center'>
                    Save Changes
                </Text>
            </TouchableOpacity>
        </ScrollView>
